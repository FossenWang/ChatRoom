# Generated by Django 2.1.3 on 2019-01-23 12:54
...
def initial_data(apps, schema_editor):
    ...
    Room.objects.create(name='Test', max_number=5)
    for i in range(1, 6):
        User.objects.create_user(f'user{i}', None, '123456')
        Room.objects.create(name=f'Room{i}', max_number=5)
